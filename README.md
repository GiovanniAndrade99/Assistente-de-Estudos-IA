...
│   │   │   professor_service.py, progresso_service.py, suporte_service.py,
│   │   │   ia_service.py, demo_service.py (dados de demonstração)
...
│   │   │   progresso_router.py, saude_router.py, suporte_router.py, ia_router.py
│   └── middlewares/
